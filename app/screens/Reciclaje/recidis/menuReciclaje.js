            ...
            <View style={styles.menuContainer}>
              <View style={{flex: 1, justifyContent: 'center'}}>
                <View style={{...styles.buttons, backgroundColor: 'beige'}}>
                  <TouchableOpacity onPress={() => this.props.navigation.navigate("game_tutorial", { questions: tutorial, tareas: this.state.tareas })}>
              ...
              <View style={{flex: 1, justifyContent: 'center'}}>
                <View style={{...styles.buttons, backgroundColor: 'pink'}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("game_facil", { questions: facil, tareas: this.state.tareas })}>
              ...
              <View style={{flex: 1, justifyContent: 'center'}}>
                <View style={{...styles.buttons, backgroundColor: 'salmon'}}>
                  <TouchableOpacity onPress={() => this.props.navigation.navigate("game_intermedio", { questions: intermedio, tareas: this.state.tareas })}>
              ...
              <View style={{flex: 1, justifyContent: 'center'}}>
                <View style={{...styles.buttons, backgroundColor: 'violet'}}>
                  <TouchableOpacity onPress={() => this.props.navigation.navigate("game_dificil", { questions: dificil, tareas: this.state.tareas })}>
